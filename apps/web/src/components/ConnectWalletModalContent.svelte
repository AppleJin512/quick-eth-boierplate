<script lang="ts">
  ...
  export let userOptions: IProviderUserOptions[] = [];
</script>

<div class="flex justify-between relative">
  <h4 class="text-32px font-bold text-title mt-15 phone:mt-10 mx-auto phone:text-center ">
    Connect your wallet
  </h4>
  <button
...
<div class="mt-8 mb-15 phone:mb-10">
